...
class GestacaoReport {
  late String user;
  late List<Gestacao> list;
  GestacaoReport({required this.list, required this.user});
}

class GestacaoPrintReport {
  GestacaoReport report;
  GestacaoPrintReport({required this.report, required this.animalMap});

  late Map<int?, Animal> animalMap;
                  ...
                  pw.Column(
                      ...
                      children: [
                        pw.Padding(
                            ...
                            child: pw.PdfLogo()),
                        pw.Text('Relatório de Gestações por Período',
  ...
  pw.Widget _contentTable(pw.Context context) {
    const tableHeaders = [
      ...
      'Gestante',
      'Provedor do Sêmen',
      'Data Inicial da Gestação',
      'Data Final da Gestação',
      'Status'
    ];
  ...
  String _getValueIndex(Gestacao gestacao, int col) {
    switch (col) {
      case 0:
        return gestacao.id.toString();
      case 1:
        return animalMap[gestacao.animalGestante]!.nome;
      case 2:
        return gestacao.animalSemen;
      case 3:
        return gestacao.dataInicial;
      case 4:
        return gestacao.dataFinal == null ? '-------' : gestacao.dataFinal;
      case 5:
        switch (gestacao.statusGest) {
          case '0':
            return 'Em andamento';
          case '1':
            return 'Nasceu';
                ...
                child: pw.Column(
                    ...
                    children: [
                      pw.Padding(
                          ...
                          child: pw.Text('Gestações no período selecionado',
                              style:
